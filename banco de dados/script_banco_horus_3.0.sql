...
ALTER TABLE servidor ADD COLUMN data_status DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
INSERT INTO servidor_componente (fk_servidor, fk_componente, limite)
VALUES (1, (SELECT id_componente FROM componente WHERE tipo = 'REDE'), 0);
